...
import 'package:returant_flutter/widgets/app_column.dart';
...
class _FoodPageBodyState extends State<FoodPageBody> {
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    image: DecorationImage(
                      fit: BoxFit.cover,
                      image: AssetImage('assets/image/download (1).jfif'),
                    ),
                  ),
                ),
                // text container
  ...
  Widget _buildPageItem(int index) {
    ...
    // print(Dimensions.pageViewTextContainer.toString());
    ...
    if (index == _currPageValue.floor()) {
      ...
      var currScale = 0.8;
      matrix = Matrix4.diagonal3Values(1, currScale, 1)
        ..setTranslationRaw(1, height * (1 - _scaleFactor) / 2, 1);
    }
    return Transform(
      transform: matrix,
      child: Stack(
