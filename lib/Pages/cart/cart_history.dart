...
import 'package:returant_flutter/models/cart_model.dart';
        ...
        GetBuilder<CartController>(builder: (_cartController) {
          return _cartController.getCartHistoryList().length > 0
              ...
              : Container(
                  ...
                  child: NoDataPage(text: 'Your History cart is empty!'));
        })
      ]),
    );
  }
